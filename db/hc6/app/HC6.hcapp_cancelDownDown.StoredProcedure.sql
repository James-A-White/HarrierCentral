CREATE OR ALTER PROCEDURE [HC6].[hcapp_cancelDownDown]
...
AS
-- =====================================================================
-- Procedure: HC6.hcapp_cancelDownDown
-- Description: Marks a DownDown charge as cancelled (IsCancelled = 1,
--   IsDone = 0). The two flags are mutually exclusive — cancelling a
--   delivered charge also clears IsDone. The operation is idempotent.
