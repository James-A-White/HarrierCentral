CREATE OR ALTER PROCEDURE [HC6].[hcportal_getCategoryDetail]
...
AS
-- =====================================================================
-- Procedure: HC6.hcportal_getCategoryDetail
-- Description: Retrieves recent activity for admin portal dashboard.
--              Returns raw data columns for 10 activity categories:
--              new hashers (0), event RSVPs (1), new events (2),
--              new kennels (3), app logins (4), payments (5),
--              portal access (6), errors (7), hashruns.org traffic (8),
--              and version adoption (100).
--              Uses a time window specified by @days parameter (default 7 days).
...
-- Created: 2026-03-15
-- HC5 Source: HC5.hcportal_getCategoryDetail
-- Breaking Changes:
