	...
	BEGIN
		...
		BEGIN
			SELECT
				...
				COALESCE(hem.TotalRunsThisKennel, 0) + COALESCE(hkm.HistoricalTotalRunCount, 0) AS totalRunsThisKennel,
				COALESCE(hem.TotalHaringThisKennel, 0) + COALESCE(hkm.HistoricalHaringCount, 0) AS totalHaringThisKennel,
