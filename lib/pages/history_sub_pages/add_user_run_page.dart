...
// class AddUserRunPage extends StatefulWidget {
...
//   @override
//   AddUserRunPageState createState() => AddUserRunPageState();
// }
...
//       title: Text(
//         widget.pageType == EnumAddUserRunType.addUserRun ? 'Add new run' : 'Edit run',
...
//     ),
//             body: _isLoading
//                 ? Container(height: MediaQuery.of(context).size.height, decoration: Backgrounds.defaultHcBackground(), child: _buildCircularProgressIndicator())
//                 : Container(
...
//                                             right: 0,
//                                             child: Text(
//                                               widget.pageType == EnumAddUserRunType.addUserRun ? 'Add user run' : 'Edit user run',
//                                               style: headingStyle,
//                                               textAlign: TextAlign.center,
//                                             ),
//                                           ),
...
//                                                         Connection2.styleForConnected(G0<AppModel>().connectionStatus,
//                                                           ElevatedButton(
//                                                             onPressed: () {
...
//                                                 ),
//                                               )),
//                                          // Positioned(top: 740, left: 30, right: 30, child: (widget.uiElementsToDisplay & (AddUserRunPage.flagUiElement_followKennel | AddUserRunPage.flagUiElement_inviteCode) == 0) ? Container() : FancyDivider(key: Key('xxxxxxxx'),innerColor: Colors.white)),
//                                           // Positioned(
//                                           //   top: 760,
...
//                                           //   left: 30,
//                                           //   right: 30,
//                                           //   child: (widget.uiElementsToDisplay & AddUserRunPage.flagUiElement_inviteCode == 0)
//                                           //       ? Container()
//                                           //       : Column(
...
//                 child: Connection2.styleForConnected(G0<AppModel>().connectionStatus,
//                   ElevatedButton(
//                     color: _isDirty ? Theme.of(context).accentColor : Colors.grey,
//                     onPressed: () {
//                       if (Connection2.checkForConnection(context,G0<AppModel>().connectionStatus) && _isDirty) {
//                         _updateProfile();
//                       }
//                     },
//                     child: Text(widget.pageType == EnumAddUserRunType.addUserRun ? 'Add New Run' : 'Save Changes', style: buttonTextStyle),
//                   ),
//                 ),
//                 height: 60,
//                 width: MediaQuery.of(context).size.width,
