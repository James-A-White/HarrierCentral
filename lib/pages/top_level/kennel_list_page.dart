          ...
          for (int i = 0; i < results.length; i++) {
            locator
                .distanceBetween(
                    ...
                    IveCoreUtilities.unInt(results[i]['cityLat']),
                    IveCoreUtilities.unInt(results[i]['cityLon']))
                .then((num dist) {
              ...
              if (i == results.length - 1) {
                if (G0<AppModel>().hasLocationPermissions) {
                  G0<TableModel>().globalKennelMainPageList.sort(
  ...
  void filterResults() {
    if (G0<TableModel>().globalKennelMainPageList != null) {
      if (searchController.text.isEmpty) {
        ...
        filteredList = QueryKennels.doFilter(
            searchText, G0<TableModel>().globalKennelMainPageList);
      }
    }
  }
