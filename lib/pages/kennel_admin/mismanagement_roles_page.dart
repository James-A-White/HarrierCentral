    ...
    return Scaffold(
      ...
      body: mmRoles == null
          ...
          : Column(children: <Widget>[
              Expanded(
                child: Container(
                  padding: const EdgeInsets.only(top: 0.0, left: 25.0, right: 25.0, bottom: 0.0),
                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        children: <Widget>[
                          ...
                          getOption('Down Down Master', mmRoles.getMismanagementState(mmRoleFlagDownDownMaster), (bool value) {
                            mmRoles.setMismanagementState(mmRoleFlagDownDownMaster, value);
                          }),
                          ...
                          getOption('Scribe Master', mmRoles.getMismanagementState(mmRoleFlagScribe), (bool value) {
                            mmRoles.setMismanagementState(mmRoleFlagScribe, value);
                          }),

                          getOption('Social Media Whore', mmRoles.getMismanagementState(mmRoleFlagSocialMediaWhore), (bool value) {
                            mmRoles.setMismanagementState(mmRoleFlagSocialMediaWhore, value);
                          }),
