...
class NotificationPermissionSliderPage extends StatefulWidget {
  const NotificationPermissionSliderPage({Key key}) : super(key: key);

  @override
  _NotificationPermissionSliderPageState createState() => _NotificationPermissionSliderPageState();
}

class _NotificationPermissionSliderPageState extends State<NotificationPermissionSliderPage> {
  ...
  Future<void> onDonePress() async {
    ...
    Navigator.of(context)
        .pushReplacementNamed(RouteNames.GET_STARTED_SLIDER.toString());
