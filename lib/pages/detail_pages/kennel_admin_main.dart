...
class KennelAdminMainPageState extends State<KennelAdminMainPage> {
  ...
  void initState() {
    ...
    if ((widget.kennelAggregateItem.kennel.kennelMismanagementTeam == null) ||
      ...
      _mismanagement = widget
              .kennelAggregateItem.kennel.kennelMismanagementTeam!
              .contains('\r')
          ? widget.kennelAggregateItem.kennel.kennelMismanagementTeam!
              .split('\r')
          : widget.kennelAggregateItem.kennel.kennelMismanagementTeam!
  ...
  Future<void> _refreshFromTable(bool forceRefresh) async {
    if (forceRefresh || (_allRuns.isEmpty)) {
      ...
      final List<Map<String, dynamic>> results = await QueryRuns.queryRuns(
          EnumRunQueryType.kennelDetailPage, EnumRunQueryContext.kennelAdmin,
        ...
        if (((eventItem.eventPaymentUrl ?? '') != '') &&
          ...
          paymentLinkUrl = eventItem.eventPaymentUrl!;
            ...
            ((kennelItem.kennelPaymentUrlExpires == null) ||
                (kennelItem.kennelPaymentUrlExpires!
      ...
      Positioned(
        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            ...
            title: Text(widget.kennelAggregateItem.kennel.kennelShortName,
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          const Padding(
                            ...
                            child: FancyDivider(
                                key: Key('16613234'), innerColor: Colors.white),
                          ),
                          if (widget
                                  .kennelAggregateItem.hkm?.appAccess.isAdmin ??
                              false)
                            Column(
                              children: <Widget>[
                                Text(
                                ...
                                if (widget.kennelAggregateItem.hkm!.appAccess
                                    .canManageRuns)
                                  Row(
                                      mainAxisAlignment:
                                                  ...
                                                  Navigator.push<dynamic>(
                                                    ...
                                                    setState(() {
                                                      if ((kennelAggregate
                                                        ...
                                                        _mismanagement = kennelAggregate
                                                                .kennel
                                                                .kennelMismanagementTeam!
                                                                .contains('\r')
                                                            ? kennelAggregate
                                                ...
                                                if (Connection2
                                                  ...
                                                  if (isPreviewBool != null) {
                                                    ...
                                                    final Map<String,
                                                            String>
                                                        result =
                                                        await svc.sendKennelInvitesByEmail(
                                                            kennelId: widget
                                                                .kennelAggregateItem
                                                                .kennel
                                                                .kennelId,
                                ...
                                const Padding(
                                  padding:
                                      EdgeInsets.only(top: 50.0, bottom: 25.0),
                                  child: FancyDivider(
                                      key: Key('5511334'),
                                      innerColor: Colors.white),
                                ),
                            ...
                            children: <Widget>[
                              ConnectedWidget(
                                ...
                                disconnectedChild: Padding(
                                  padding:
                                      const EdgeInsets.only(top: 1, bottom: 30),
                                  child: Center(
                                    child: Text(
                                ...
                                child: SizedBox(
                                  ...
                                  child: Center(
                                    // Map
                                    child: (widget.kennelAggregateItem
                                                .extensions.cityLat ==
                                            null)
                                        ? const SizedBox()
                                        : FlutterMap(
                              ...
                              Column(
                                children: <Widget>[
                                      ...
                                      ElevatedButton(
                                        ...
                                        onPressed: () async {
                                          final List<Map<String, dynamic>>
                                              results = await QueryKennels
                                                  .queryKennelGallery(widget
                                                      .kennelAggregateItem
                                                      .kennel
                                                      .kennelId);
                                  ...
                                  if (widget.kennelAggregateItem.extensions
                                          .isKennelMember ==
                                      1) ...<Widget>[
                                    const FancyDivider(
                                      key: Key('5203920'),
