            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Container(child:Text('\r\n2. Harrier Central Service', style: headingStyle),margin:EdgeInsets.only(top:15)),
                  Text(
                  ...
                  Container(child:Text('\r\n3. Harrier Central Access', style: headingStyle),margin:EdgeInsets.only(top:15)),
                  Container(child:Text(
                  ...
                  Container(child:Text(
                    '(5) You acknowledge You will not be able to access and Use certain functionalities of the App unless You have internet access through a GPRS, 3G or Wi-Fi connected mobile device. All traffic charges or access charges incurred due to the Use of the App are subject to Your agreed terms with your mobile network provider.',
                    style: bodyStyle,
                    textAlign: TextAlign.justify,
                  ),margin:EdgeInsets.only(top:15,left:20,right:20)),
                  ...
                  Container(child:Text('\r\n4. Claims of Copyright Infringement', style: headingStyle),margin:EdgeInsets.only(top:15)),
                  Text(
                  ...
                  Container(child:Text('\r\n5. Warranties and Liabilities', style: headingStyle),margin:EdgeInsets.only(top:15)),
                  ...
                  Container(child:Text('\r\n6. Indemnity', style: headingStyle),margin:EdgeInsets.only(top:15)),
                  Text(
                    ...
                    textAlign: TextAlign.justify,
                                    ...
                                    Container(child:Text('\r\n7. General', style: headingStyle),margin:EdgeInsets.only(top:15)),
                  Container(child:Text(
