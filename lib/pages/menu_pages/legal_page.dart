            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Container(margin: const EdgeInsets.only(top: 15), child: Text('\r\n3. Harrier Central Access', style: headingStyle)),
                  Container(
                  ...
                  Container(margin: const EdgeInsets.only(top: 15), child: Text('\r\n4. Claims of Copyright Infringement', style: headingStyle)),
                  Text(
                  ...
                  Container(margin: const EdgeInsets.only(top: 15), child: Text('\r\n5. Warranties and Liabilities', style: headingStyle)),
                  Container(
                      margin: const EdgeInsets.only(top: 10, left: 20, right: 20),
                      child: Text(
