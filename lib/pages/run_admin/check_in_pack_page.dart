    ...
    try {
      final String sql = ''' 
          ...
          SELECT 
            ...
            lower(coalesce(h.dispName,"") || " " || coalesce(h.firstName,"") || " " || coalesce(h.lastName,"")) as nameForSort,
            0 as paymentType,
            0 as creditAmount,
            h.photo,
    ...
    try {
      final String sql = ''' 
          ...
          SELECT 
            ...
            lower(coalesce(h3.dispName,"") || " " || coalesce(h3.lastName,"") || " " || coalesce(h3.firstName,"")) as nameForSort,
