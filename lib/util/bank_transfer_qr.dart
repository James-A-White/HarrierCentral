...
class BankTransferQr
{
          ...
          content: Container(
            ...
            child: RaisedButton(
              ...
              onPressed: () {
                ...
                final String remittanceInfo = '${eventAggregate.kennel.kennelShortName}, $paidFor, $packMemberNameForDisplay' + paymentReference;
  ...
  static void showBankTransferQrCode(BuildContext context, RunAdminAggregate eventAggregate, bool member, {String remitString, num remitAmount}) {
    ...
    String remittanceInfo = '${eventAggregate.event.eventStartDatetime.toString().substring(0, 10)} - ${eventAggregate.event.eventName}';
    String beneficiaryInfo = '${eventAggregate.event.eventStartDatetime.toString().substring(0, 10)} - ${eventAggregate.event.eventName}';
