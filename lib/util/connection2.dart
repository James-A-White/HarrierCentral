...
class Connection2 {
  ...
  static Widget styleForConnected(EnumConnectionStatus2 status, Widget w, {num borderRadius = 0.0}) {
    return Container(
      foregroundDecoration: status == EnumConnectionStatus2.connected
          ? const BoxDecoration()
          : BoxDecoration(
  ...
  static bool checkForConnection(EnumConnectionStatus2 status,
