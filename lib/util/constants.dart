...
const num ALLOW_AUTO_CHECKIN_HOURS_BEFORE_EVENT = 1;
const num ALLOW_AUTO_CHECKIN_HOURS_AFTER_EVENT = 6;

const num GEOFENCE_IN_METERS_AROUND_RUN_START_FOR_AUTO_CHECKIN = 1000;
