...
class RunListItem extends StatefulWidget {
  const RunListItem(
      {Key key, @required this.futureRun, @required this.onItemTapped})
      : super(key: key);
    ...
    if (rawIcon == null) {
      if ((rsvpState == 3) && (willHareState == 1)) {
        return Padding(
          ...
          child: Image.asset('images/icons/hare_icon.png',
              color: Colors.deepPurple, height: 22.0, width: 22.0),
        );
      } else {
        return Container();
      }
            ...
            children: <Widget>[
              ...
              GestureDetector(
                ...
                child: Padding(
                    ...
                    child: getRsvpWidget(widget.futureRun.extensions.rsvpState,
                        widget.futureRun.extensions.isHare)),
              ),
              Container(
                ...
                child: GestureDetector(
                  ...
                  child: widget.futureRun.extensions.emailAlertPreference == -1
                      ...
                      : Image(
                          ...
                          height: 24.0,
                          fit: BoxFit.fill,
                          image: widget.futureRun.extensions
                                      .emailAlertPreference ==
                                  1
                              ? const AssetImage(
                                  'images/icons/envelope_gold_50px.png')
                              : widget.futureRun.extensions
                                          .emailAlertPreference ==
                                      2
                                  ? const AssetImage(
              ...
              widget.futureRun.event.eventStartDatetime.isAfter(DateTime.now()
                  ...
                  : Container(
                      ...
                      child: GestureDetector(
                        ...
                        child: widget.futureRun.extensions
                                    .notificationPreference ==
                                -1
                            ? Icon(delayIcon,
                                color: Colors.blue[800], size: 24.0)
                            : Image(
                                width: 24.0,
                                height: 24.0,
                                fit: BoxFit.fill,
                                image: widget.futureRun.extensions
                                        ...
                                        1
                                    ? const AssetImage(
                                        'images/icons/bell_gold_50px.png')
                                    : widget.futureRun.extensions
                                                .notificationPreference ==
                                            2
                                        ? const AssetImage(
                  ...
                  Expanded(
                    ...
                    child: FlatButton(
                      ...
                      padding: const EdgeInsets.only(
                          top: 10.0, left: 4.0, right: 0.0, bottom: 10.0),
                      child: Row(
                        crossAxisAlignment: CrossAxisAlignment.center,
                        ...
                        children: <Widget>[
                                ...
                                children: <Widget>[
                                  Text(
                                    (widget.futureRun.event.isCountedRun == 1
                                            ...
                                            : 'Run / Event ') +
                                        (widget.futureRun.extensions.daysUntilEvent <=
                                                14
                                            ? widget.futureRun.extensions.daysUntilEvent.toInt() ==
                                                    0
                                                ? 'TODAY'
                                                : widget.futureRun.extensions
                                                            .daysUntilEvent
                                            ...
                                            : (widget.futureRun.extensions.daysUntilEvent <=
                                                    30)
                                                ? 'in ' +
                                                    (widget.futureRun.extensions.daysUntilEvent ~/ 7.0)
                                                        .toString() +
                                                    ((widget.futureRun.extensions.daysUntilEvent ~/ 7.0) == 1
                                                        ? ' week'
                                                        : ' weeks')
                                                : widget.futureRun.extensions
                                                            .daysUntilEvent <=
                                                        365
                                                    ? 'in ' +
                                                        (widget.futureRun.extensions.daysUntilEvent ~/ 30.0)
                                                            .toString() +
                                                        ((widget.futureRun.extensions.daysUntilEvent ~/ 30.0) == 1
                                                            ? ' month'
                                                            : ' months')
                                                    : 'in ' +
                                                        (widget.futureRun.extensions.daysUntilEvent ~/ 365.0)
                                                            .toString() +
                                                        ((widget.futureRun.extensions.daysUntilEvent ~/ 365.0) == 1
                                                            ? ' year'
                                                            : ' years')),
                                    style: const TextStyle(
                          ...
                          IconButton(
                            icon: Connection.styleForConnected(const Icon(
        ...
        <String, dynamic>{
          ...
          'icon': <Widget>[
            ...
            const ImageIcon(AssetImage('images/icons/hare_icon.png'),
                color: Colors.deepPurple, size: 26.0)
          ],
    ...
    if ((retVal == notificationsOn) ||
      ...
      hasherEventMapService
        ...
        setState(() {
          ...
          widget.futureRun.extensions.notificationPreference =
              results[0]['notificationPreference'] ?? 0;
        });
      });
    }
  }
    ...
    if ((retVal == emailAlertsOn) ||
      ...
      hasherEventMapService
        ...
        emailAlertState: nState.value,
          ...
          .then((List<dynamic> results) {
        setState(() {
          widget.futureRun.extensions.emailAlertPreference =
              results[0]['emailAlertPreference'] ?? 0;
        });
      });
    }
  }
