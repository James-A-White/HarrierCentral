...
class KennelLogo extends StatelessWidget {
  ...
  String? get _assetImagePath {
    ...
    final basePath = kennelLogoUrl!.toLowerCase().contains('avatar') ? 'images/avatars/' : 'images/generic_logos/';
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onTap: zoomGesture == KennelLogoZoomGesture.tap ? () => _showZoomPage(context) : null,
      onLongPress: zoomGesture == KennelLogoZoomGesture.longPress ? () => _showZoomPage(context) : null,
      child: Container(
        width: logoHeight,
        height: logoHeight,
        ...
        child: _isBundleImage
            ? Stack(
                ...
                children: [
                  ...
                  if (!(kennelShortName ?? '').toLowerCase().contains('my runs'))
                    Padding(
