...
//import 'package:harrier_central/pages/kennel_detail_page.dart';
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: ScopedModelDescendant<KennelScopedModel>(
                builder: (BuildContext context, Widget child, KennelScopedModel model) => IconButton(
                      icon: Icon(
                          (kennel.followingRequested ?? kennel.followingBool) ==
                                  1
                              ? const Icon(FontAwesomeIcons.solidCheckCircle).icon
                              : (kennel.followingRequested ??
                                          kennel.followingBool) ==
                                      2
                                  ? const Icon(FontAwesomeIcons.solidTimesCircle).icon
                                  : const Icon(FontAwesomeIcons.circle).icon,
