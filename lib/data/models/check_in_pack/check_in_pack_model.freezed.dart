...
mixin _$CheckInPackModel implements DiagnosticableTreeMixin {
  ...
  $CheckInPackModelCopyWith<CheckInPackModel> get copyWith =>
      _$CheckInPackModelCopyWithImpl<CheckInPackModel>(
          this as CheckInPackModel, _$identity);
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    properties
      ...
      ..add(DiagnosticsProperty('nameForDisplay', nameForDisplay))
      ...
      ..add(DiagnosticsProperty('hemUpdatedAt', hemUpdatedAt))
      ..add(DiagnosticsProperty('payUpdatedAt', payUpdatedAt))
      ..add(DiagnosticsProperty('credit', credit))
      ..add(DiagnosticsProperty('isFollowing', isFollowing))
      ..add(DiagnosticsProperty('rsvpStateIndicator', rsvpStateIndicator))
      ..add(DiagnosticsProperty(
          'attendenceStateIndicator', attendenceStateIndicator))
      ..add(DiagnosticsProperty('paidStateIndicator', paidStateIndicator));
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.nameForDisplay, nameForDisplay) ||
                other.nameForDisplay == nameForDisplay) &&
            ...
            (identical(other.hemUpdatedAt, hemUpdatedAt) ||
                other.hemUpdatedAt == hemUpdatedAt) &&
            (identical(other.payUpdatedAt, payUpdatedAt) ||
...
abstract mixin class $CheckInPackModelCopyWith<$Res> {
  factory $CheckInPackModelCopyWith(
          CheckInPackModel value, $Res Function(CheckInPackModel) _then) =
      _$CheckInPackModelCopyWithImpl;
  @useResult
  $Res call(
      {String? hasherId,
      String? hemId,
    ...
    return _then(_self.copyWith(
      ...
      isPaid: null == isPaid
          ...
          : isPaid // ignore: cast_nullable_to_non_nullable
              as int,
      nameForDisplay: null == nameForDisplay
          ? _self.nameForDisplay
          : nameForDisplay // ignore: cast_nullable_to_non_nullable
              as String,
...
/// @nodoc
@JsonSerializable()
class _CheckInPackModel
    with DiagnosticableTreeMixin
    implements CheckInPackModel {
  _CheckInPackModel(
      {this.hasherId,
      this.hemId,
      this.isMember = 0,
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$CheckInPackModelCopyWith<_CheckInPackModel> get copyWith =>
      __$CheckInPackModelCopyWithImpl<_CheckInPackModel>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$CheckInPackModelToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$CheckInPackModelCopyWith<$Res>
    implements $CheckInPackModelCopyWith<$Res> {
  factory _$CheckInPackModelCopyWith(
          _CheckInPackModel value, $Res Function(_CheckInPackModel) _then) =
      __$CheckInPackModelCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String? hasherId,
