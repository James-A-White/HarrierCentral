...
/// Adds pattern-matching-related methods to [AreWeAtRunModel].
extension AreWeAtRunModelPatterns on AreWeAtRunModel {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _AreWeAtRunModel value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _AreWeAtRunModel() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _AreWeAtRunModel value)  $default,){
final _that = this;
switch (_that) {
case _AreWeAtRunModel():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _AreWeAtRunModel value)?  $default,){
final _that = this;
switch (_that) {
case _AreWeAtRunModel() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String eventId,  String eventName,  String? eventImage,  String kennelId,  String kennelLogo,  String kennelShortName,  int eventNumber,  double distanceInMeters,  double deltaHours,  double kennelCredit,  double memberPrice,  double nonMemberPrice,  double extrasCost,  double discountAmount,  double discountPercent,  int attendenceState,  int digitsAfterDecimal,  int allowSelfPayment,  String currencySymbol,  DateTime membershipExpirationDate,  String? extrasDescription)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AreWeAtRunModel() when $default != null:
return $default(_that.eventId,_that.eventName,_that.eventImage,_that.kennelId,_that.kennelLogo,_that.kennelShortName,_that.eventNumber,_that.distanceInMeters,_that.deltaHours,_that.kennelCredit,_that.memberPrice,_that.nonMemberPrice,_that.extrasCost,_that.discountAmount,_that.discountPercent,_that.attendenceState,_that.digitsAfterDecimal,_that.allowSelfPayment,_that.currencySymbol,_that.membershipExpirationDate,_that.extrasDescription);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String eventId,  String eventName,  String? eventImage,  String kennelId,  String kennelLogo,  String kennelShortName,  int eventNumber,  double distanceInMeters,  double deltaHours,  double kennelCredit,  double memberPrice,  double nonMemberPrice,  double extrasCost,  double discountAmount,  double discountPercent,  int attendenceState,  int digitsAfterDecimal,  int allowSelfPayment,  String currencySymbol,  DateTime membershipExpirationDate,  String? extrasDescription)  $default,) {final _that = this;
switch (_that) {
case _AreWeAtRunModel():
return $default(_that.eventId,_that.eventName,_that.eventImage,_that.kennelId,_that.kennelLogo,_that.kennelShortName,_that.eventNumber,_that.distanceInMeters,_that.deltaHours,_that.kennelCredit,_that.memberPrice,_that.nonMemberPrice,_that.extrasCost,_that.discountAmount,_that.discountPercent,_that.attendenceState,_that.digitsAfterDecimal,_that.allowSelfPayment,_that.currencySymbol,_that.membershipExpirationDate,_that.extrasDescription);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String eventId,  String eventName,  String? eventImage,  String kennelId,  String kennelLogo,  String kennelShortName,  int eventNumber,  double distanceInMeters,  double deltaHours,  double kennelCredit,  double memberPrice,  double nonMemberPrice,  double extrasCost,  double discountAmount,  double discountPercent,  int attendenceState,  int digitsAfterDecimal,  int allowSelfPayment,  String currencySymbol,  DateTime membershipExpirationDate,  String? extrasDescription)?  $default,) {final _that = this;
switch (_that) {
case _AreWeAtRunModel() when $default != null:
return $default(_that.eventId,_that.eventName,_that.eventImage,_that.kennelId,_that.kennelLogo,_that.kennelShortName,_that.eventNumber,_that.distanceInMeters,_that.deltaHours,_that.kennelCredit,_that.memberPrice,_that.nonMemberPrice,_that.extrasCost,_that.discountAmount,_that.discountPercent,_that.attendenceState,_that.digitsAfterDecimal,_that.allowSelfPayment,_that.currencySymbol,_that.membershipExpirationDate,_that.extrasDescription);case _:
  return null;
