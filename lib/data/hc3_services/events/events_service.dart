...
class EventsTableHelper extends BaseTableHelper with BaseFields {
  ...
  Future<dynamic> createTable(
    ...
    await db.execute('''
          CREATE TABLE $tableName (
            ...
            $colIsPromotedEvent INT NOT NULL,
            $colEventGeographicScope INT NOT NULL,
            ...
            $colDoTrackHashCash INT NOT NULL,
            $colTags1 INT NOT NULL,
            $colTags2 INT NOT NULL,
            $colTags3 INT NOT NULL,
            $colUseFbLatLon INT NOT NULL,
            $colUseFbLocation INT NOT NULL,
            $colUseFbRunDetails INT NOT NULL,
            $colUseFbImage INT NOT NULL,
  ...
  EventModel fromMap(Map<String, dynamic> map) {
    EventModel item = EventModel.fromJson(map);
