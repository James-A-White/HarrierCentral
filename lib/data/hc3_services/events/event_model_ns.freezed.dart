...
mixin _$EventModel {
  ...
  String? get locationOneLineDesc => throw _privateConstructorUsedError;
  String? get locationPostCode => throw _privateConstructorUsedError;
  String? get locationCity => throw _privateConstructorUsedError;
  String? get locationStreet => throw _privateConstructorUsedError;
  ...
  String? get locationSubRegion => throw _privateConstructorUsedError;
  String? get hares => throw _privateConstructorUsedError;
  String? get eventPaymentScheme => throw _privateConstructorUsedError;
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.eventInboundIntegrationId, eventInboundIntegrationId) ||
            ...
            (identical(other.fbLatitude, fbLatitude) ||
                other.fbLatitude == fbLatitude) &&
            (identical(other.fbLongitude, fbLongitude) ||
                other.fbLongitude == fbLongitude) &&
            (identical(other.eventPriceForMembers, eventPriceForMembers) ||
                other.eventPriceForMembers == eventPriceForMembers) &&
            (identical(other.eventPriceForNonMembers, eventPriceForNonMembers) ||
            ...
            (identical(other.evtDisseminateAllowWebLinks, evtDisseminateAllowWebLinks) ||
                other.evtDisseminateAllowWebLinks ==
                    evtDisseminateAllowWebLinks) &&
            (identical(other.eventFacebookId, eventFacebookId) ||
                other.eventFacebookId == eventFacebookId) &&
            ...
            (identical(other.locationPostCode, locationPostCode) ||
                other.locationPostCode == locationPostCode) &&
            (identical(other.locationCity, locationCity) ||
                other.locationCity == locationCity) &&
            (identical(other.locationStreet, locationStreet) ||
                other.locationStreet == locationStreet) &&
            ...
            (identical(other.unconfirmedBankXferCount, unconfirmedBankXferCount) || other.unconfirmedBankXferCount == unconfirmedBankXferCount) &&
            ...
            (identical(other.useFbLocation, useFbLocation) || other.useFbLocation == useFbLocation) &&
            (identical(other.useFbLatLon, useFbLatLon) || other.useFbLatLon == useFbLatLon) &&
            (identical(other.useFbRunDetails, useFbRunDetails) || other.useFbRunDetails == useFbRunDetails) &&
            (identical(other.useFbImage, useFbImage) || other.useFbImage == useFbImage) &&
