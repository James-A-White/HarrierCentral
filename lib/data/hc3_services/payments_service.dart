...
class PaymentsService {
  Future<List<dynamic>> payForEvent(
    ...
    final Response response = await post(BASE_API_URL + 'hc3_process_payment',
  ...
  Future<Map<String, String>> sendPaymentReportByEmail({
    ...
    final String accessToken =
        IveCoreUtilities.generateToken(userId, 'getPaymentReport');
    ...
    if ((emailAddress ?? '').isNotEmpty) {
      ...
      final Response response = await post(EMAIL_PAYMENT_API_URL,
              headers: <String, String>{'content-type': 'application/json'},
              body: body
              // Send authorization headers to your backend
              //headers: {HttpHeaders.authorizationHeader: 'Basic your_api_token_here'},
