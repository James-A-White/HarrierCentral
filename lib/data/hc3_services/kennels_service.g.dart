...
KennelsModel _$KennelsModelFromJson(Map<String, dynamic> json) {
  return KennelsModel(
    ...
    defaultRunStartTime: json['defaultRunStartTime'] == null ? null : DateTime.parse(json['defaultRunStartTime'] as String),
    ...
    kennelPaymentUrlExpires: json['kennelPaymentUrlExpires'] == null ? null : DateTime.parse(json['kennelPaymentUrlExpires'] as String),
    kennelPaymentMemberSurcharge: json['kennelPaymentMemberSurcharge'] as num,
    kennelPaymentNonMemberSurcharge: json['kennelPaymentNonMemberSurcharge'] as num,
    kennelPaymentScheme2: json['kennelPaymentScheme2'] as String,
    kennelPaymentUrl2: json['kennelPaymentUrl2'] as String,
    kennelPaymentUrlExpires2: json['kennelPaymentUrlExpires2'] == null ? null : DateTime.parse(json['kennelPaymentUrlExpires2'] as String),
    kennelPaymentMemberSurcharge2: json['kennelPaymentMemberSurcharge2'] as num,
    kennelPaymentNonMemberSurcharge2: json['kennelPaymentNonMemberSurcharge2'] as num,
    kennelPaymentScheme3: json['kennelPaymentScheme3'] as String,
    kennelPaymentUrl3: json['kennelPaymentUrl3'] as String,
    kennelPaymentUrlExpires3: json['kennelPaymentUrlExpires3'] == null ? null : DateTime.parse(json['kennelPaymentUrlExpires3'] as String),
    kennelPaymentMemberSurcharge3: json['kennelPaymentMemberSurcharge3'] as num,
    kennelPaymentNonMemberSurcharge3: json['kennelPaymentNonMemberSurcharge3'] as num,
    runCountStartDate: json['runCountStartDate'] == null ? null : DateTime.parse(json['runCountStartDate'] as String),
...
Map<String, dynamic> _$KennelsModelToJson(KennelsModel instance) => <String, dynamic>{
      ...
      'kennelPaymentUrlExpires': instance.kennelPaymentUrlExpires?.toIso8601String(),
      ...
      'kennelPaymentUrlExpires2': instance.kennelPaymentUrlExpires2?.toIso8601String(),
      ...
      'kennelPaymentUrlExpires3': instance.kennelPaymentUrlExpires3?.toIso8601String(),
