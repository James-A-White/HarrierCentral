...
_$_HasherEventMapModel _$$_HasherEventMapModelFromJson(
    ...
    _$_HasherEventMapModel(
      ...
      eventCountOverride: json['eventCountOverride'] as int?,
      virginVisitorType: json['virginVisitorType'] as int,
      ...
      hemCanEditRunAttendence: json['hemCanEditRunAttendence'] as int?,
