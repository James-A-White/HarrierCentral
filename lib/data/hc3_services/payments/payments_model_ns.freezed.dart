...
mixin _$PaymentsModel implements DiagnosticableTreeMixin {
  ...
  $PaymentsModelCopyWith<PaymentsModel> get copyWith =>
      _$PaymentsModelCopyWithImpl<PaymentsModel>(
          this as PaymentsModel, _$identity);
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    properties
      ...
      ..add(DiagnosticsProperty('paidTo', paidTo))
      ...
      ..add(DiagnosticsProperty('paidDate', paidDate))
      ..add(DiagnosticsProperty('paymentType', paymentType))
      ..add(DiagnosticsProperty('productType', productType))
      ..add(DiagnosticsProperty('cancelledDate', cancelledDate))
      ..add(DiagnosticsProperty('cancelledBy', cancelledBy))
      ..add(DiagnosticsProperty('confirmedDate', confirmedDate))
      ..add(DiagnosticsProperty('confirmedBy', confirmedBy))
      ..add(DiagnosticsProperty('paymentReference', paymentReference))
      ..add(DiagnosticsProperty('notes', notes))
      ..add(DiagnosticsProperty('doPayForExtras', doPayForExtras))
      ..add(DiagnosticsProperty('surcharge', surcharge))
      ..add(DiagnosticsProperty('paymentProvider', paymentProvider))
      ...
      ..add(DiagnosticsProperty('specialRunPriceReason', specialRunPriceReason))
...
abstract mixin class $PaymentsModelCopyWith<$Res> {
  factory $PaymentsModelCopyWith(
          PaymentsModel value, $Res Function(PaymentsModel) _then) =
      _$PaymentsModelCopyWithImpl;
  @useResult
  $Res call(
      {String paymentId,
      String kennelId,
...
class _PaymentsModel with DiagnosticableTreeMixin implements PaymentsModel {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$PaymentsModelCopyWith<_PaymentsModel> get copyWith =>
      __$PaymentsModelCopyWithImpl<_PaymentsModel>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$PaymentsModelToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$PaymentsModelCopyWith<$Res>
    implements $PaymentsModelCopyWith<$Res> {
  factory _$PaymentsModelCopyWith(
          _PaymentsModel value, $Res Function(_PaymentsModel) _then) =
      __$PaymentsModelCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String paymentId,
