...
mixin _$ReceiptsModel implements DiagnosticableTreeMixin {
  ...
  $ReceiptsModelCopyWith<ReceiptsModel> get copyWith =>
      _$ReceiptsModelCopyWithImpl<ReceiptsModel>(
          this as ReceiptsModel, _$identity);
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    properties
      ...
      ..add(DiagnosticsProperty('receiptAmount', receiptAmount))
      ..add(DiagnosticsProperty('costCategory', costCategory))
      ..add(DiagnosticsProperty('dateUploaded', dateUploaded))
      ..add(DiagnosticsProperty('imageUrl', imageUrl))
      ..add(DiagnosticsProperty('receiptShortDesc', receiptShortDesc))
      ..add(DiagnosticsProperty('notes', notes))
      ..add(DiagnosticsProperty('reimbursedBy', reimbursedBy))
      ..add(DiagnosticsProperty('reimbursedOn', reimbursedOn))
      ..add(DiagnosticsProperty('reimbursedAmount', reimbursedAmount))
      ..add(DiagnosticsProperty('reimbursedNotes', reimbursedNotes))
...
abstract mixin class $ReceiptsModelCopyWith<$Res> {
  factory $ReceiptsModelCopyWith(
          ReceiptsModel value, $Res Function(ReceiptsModel) _then) =
      _$ReceiptsModelCopyWithImpl;
  @useResult
  $Res call(
      {String receiptId,
      String eventId,
...
class _ReceiptsModel with DiagnosticableTreeMixin implements ReceiptsModel {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ReceiptsModelCopyWith<_ReceiptsModel> get copyWith =>
      __$ReceiptsModelCopyWithImpl<_ReceiptsModel>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ReceiptsModelToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$ReceiptsModelCopyWith<$Res>
    implements $ReceiptsModelCopyWith<$Res> {
  factory _$ReceiptsModelCopyWith(
          _ReceiptsModel value, $Res Function(_ReceiptsModel) _then) =
      __$ReceiptsModelCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String receiptId,
