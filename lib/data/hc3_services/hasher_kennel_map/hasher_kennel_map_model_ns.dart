...
class HasherKennelMapModel with _$HasherKennelMapModel implements BaseModel {
  factory HasherKennelMapModel({
    ...
    required String? authorizedDeviceList,
    required int? authorizedDeviceCount,
    ...
    required DateTime? dateOfLastRun,
    required DateTime? membershipExpirationDate,
    required DateTime? memberSince,
    required int? isKennelFollowing,
    required int mismanagementRoles,
    required String? kennelUserPhoto,
    required String? kennelHashName,
