  ...
  static Future<List<Map<String, dynamic>>> queryKennels(EnumKennelQueryType queryType, EnumKennelQueryContext queryContext, {String hasherId, String kennelId}) async {
    ...
    final String queryBase = ''' 
        ...
        SELECT  
          ...
          (SELECT min(${G0<TableModel>().eventsTableHelper.colEventStartDatetime}) from narrowEvents e where e.${G0<TableModel>().eventsTableHelper.colKennelId} = k.${G0<TableModel>().kennelsTableHelper.colKennelId} and e.${G0<TableModel>().eventsTableHelper.colEventStartDatetime} >= datetime('now','localtime') and e.${G0<TableModel>().eventsTableHelper.colIsVisible} != 0 ) as nextRunDate,
          (SELECT max(${G0<TableModel>().eventsTableHelper.colEventStartDatetime}) from narrowEvents e where e.${G0<TableModel>().eventsTableHelper.colKennelId} = k.${G0<TableModel>().kennelsTableHelper.colKennelId} and e.${G0<TableModel>().eventsTableHelper.colEventStartDatetime} <= datetime('now','localtime') and e.${G0<TableModel>().eventsTableHelper.colIsVisible} != 0 ) as lastRunDate,
