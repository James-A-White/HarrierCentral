...
// The app is set in Avenir Next. Devices that have it (every iPhone and Mac)
// get it; the rest get the closest free faces (James, 2026-09-17).
const nunito = Nunito_Sans({ subsets: ["latin"], weight: ["400", "600", "700"], variable: "--font-fallback" });
const robotoCondensed = Roboto_Condensed({ subsets: ["latin"], weight: ["400", "700"], variable: "--font-fallback-condensed" });
...
export default async function MemberLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <html lang="en" className="dark">
      <body className={`${nunito.variable} ${robotoCondensed.variable} member-font text-zinc-100 antialiased overflow-x-hidden`}>
