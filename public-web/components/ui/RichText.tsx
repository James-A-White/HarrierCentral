  ...
  return (
    <div className="min-w-0 w-full" style={{ color: textColor, textAlign }}>
      <ReactMarkdown
        ...
        components={{
          h1: ({ children }) => (
            <h1 className="text-4xl font-black mt-8 mb-3 first:mt-0" style={{ color: "var(--kennel-text-title)" }}>
              {children}
            </h1>
          ),
          h2: ({ children }) => (
            <h2 className="text-3xl font-bold mt-7 mb-3 first:mt-0" style={{ color: "var(--kennel-text-title)" }}>
              {children}
            </h2>
          ),
          h3: ({ children }) => (
            <h3 className="text-2xl font-bold mt-6 mb-2 first:mt-0" style={{ color: "var(--kennel-text-title)" }}>
              {children}
            </h3>
          ),
          h4: ({ children }) => (
            <h4 className="text-xl font-semibold mt-5 mb-2 first:mt-0" style={{ color: "var(--kennel-text-title)" }}>
              {children}
            </h4>
          ),
          p: ({ children }) => (
          ...
          strong: ({ children }) => (
            <strong className="font-semibold" style={{ color: "var(--kennel-text-title)" }}>
              {children}
            </strong>
          ),
          em: ({ children }) => (
