...
class KennelMemberListItem extends StatelessWidget {
  ...
  final FutureOr<void> Function(EnumMemberPopupActions?)
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () async {
        final result = await Navigator.of(context).push<HashersModel>(
                      ...
                      Expanded(
                        child: Row(
                          children: <Widget>[
                            ...
                            if (Mismanagement(
                              kennelMember.mismanagementRoles,
                    ...
                    Text(
                      (kennelMember.kennelCredit >= 0
                          ...
                          IveCoreUtilities.getFormattedMoney(
                            ...
                            kennelListAggregate.kennel.digitsAfterDecimal ?? 2,
                            kennelListAggregate.kennel.currencySymbol ??
                                kennelListAggregate.extensions.currencySymbol ??
                                r'$^',
                          ),
                      style: TextStyle(
                    ...
                    onPressed: () async {
                      ...
                      final List<Map<String, dynamic>> buttons =
                          <Map<String, dynamic>>[
                            ...
                            <String, dynamic>{
                              ...
                              'returnValue':
                                  EnumMemberPopupActions.addSixMonths,
                            },
                            <String, dynamic>{
                              'title': 'Add one year',
                              'icon': <Widget>[
                      ...
                      final MultipleChoicePopupHc popup = MultipleChoicePopupHc(
                        ...
                        cancelButtonReturnValue:
                            EnumMemberPopupActions.cancelDialog,
                      );

                      final EnumMemberPopupActions? action =
                          await showDialog<EnumMemberPopupActions?>(
                            context: context,
                      ...
                      if (action != EnumMemberPopupActions.cancelDialog) {
                        await modifyMembershipCallback(action);
                      }
                    },
                  ),
                ),
