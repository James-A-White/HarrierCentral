...
/// Adds pattern-matching-related methods to [PaymentQueryExtensionsModel].
extension PaymentQueryExtensionsModelPatterns on PaymentQueryExtensionsModel {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _PaymentQueryExtensionsModel value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _PaymentQueryExtensionsModel() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _PaymentQueryExtensionsModel value)  $default,){
final _that = this;
switch (_that) {
case _PaymentQueryExtensionsModel():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _PaymentQueryExtensionsModel value)?  $default,){
final _that = this;
switch (_that) {
case _PaymentQueryExtensionsModel() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String pkHemId,  String paidByName,  String paidToName,  int isMember,  double creditAvailable,  double eventPriceForMembers,  double eventPriceForNonMembers,  String? confByName,  double extrasPrice,  String? extrasDescription,  double discountAmountAvailable,  int discountPercentAvailable,  int isFollowing,  String? discountAvailableDescription,  bool isHashCredit)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PaymentQueryExtensionsModel() when $default != null:
return $default(_that.pkHemId,_that.paidByName,_that.paidToName,_that.isMember,_that.creditAvailable,_that.eventPriceForMembers,_that.eventPriceForNonMembers,_that.confByName,_that.extrasPrice,_that.extrasDescription,_that.discountAmountAvailable,_that.discountPercentAvailable,_that.isFollowing,_that.discountAvailableDescription,_that.isHashCredit);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String pkHemId,  String paidByName,  String paidToName,  int isMember,  double creditAvailable,  double eventPriceForMembers,  double eventPriceForNonMembers,  String? confByName,  double extrasPrice,  String? extrasDescription,  double discountAmountAvailable,  int discountPercentAvailable,  int isFollowing,  String? discountAvailableDescription,  bool isHashCredit)  $default,) {final _that = this;
switch (_that) {
case _PaymentQueryExtensionsModel():
return $default(_that.pkHemId,_that.paidByName,_that.paidToName,_that.isMember,_that.creditAvailable,_that.eventPriceForMembers,_that.eventPriceForNonMembers,_that.confByName,_that.extrasPrice,_that.extrasDescription,_that.discountAmountAvailable,_that.discountPercentAvailable,_that.isFollowing,_that.discountAvailableDescription,_that.isHashCredit);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String pkHemId,  String paidByName,  String paidToName,  int isMember,  double creditAvailable,  double eventPriceForMembers,  double eventPriceForNonMembers,  String? confByName,  double extrasPrice,  String? extrasDescription,  double discountAmountAvailable,  int discountPercentAvailable,  int isFollowing,  String? discountAvailableDescription,  bool isHashCredit)?  $default,) {final _that = this;
switch (_that) {
case _PaymentQueryExtensionsModel() when $default != null:
return $default(_that.pkHemId,_that.paidByName,_that.paidToName,_that.isMember,_that.creditAvailable,_that.eventPriceForMembers,_that.eventPriceForNonMembers,_that.confByName,_that.extrasPrice,_that.extrasDescription,_that.discountAmountAvailable,_that.discountPercentAvailable,_that.isFollowing,_that.discountAvailableDescription,_that.isHashCredit);case _:
  return null;
