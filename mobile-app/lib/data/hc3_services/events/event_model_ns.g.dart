...
_EventModel _$EventModelFromJson(Map<String, dynamic> json) => _EventModel(
  ...
  eventStartDatetimeGmt: DateTime.parse(
    json['eventStartDatetimeGmt'] as String,
  ),
  ...
  eventInboundIntegrationId: (json['eventInboundIntegrationId'] as num).toInt(),
  ...
  trackRunnerCount: (json['trackRunnerCount'] as num?)?.toInt(),
  photoCount: (json['photoCount'] as num?)?.toInt(),
  messageCount: (json['messageCount'] as num?)?.toInt(),
  downDownCount: (json['downDownCount'] as num?)?.toInt(),
  eventImage: json['eventImage'] as String?,
  eventCoverPhotoUrl: json['eventCoverPhotoUrl'] as String?,
...
Map<String, dynamic> _$EventModelToJson(
  ...
  'eventStartDatetimeGmt': instance.eventStartDatetimeGmt.toIso8601String(),
  ...
  'trackRunnerCount': instance.trackRunnerCount,
  'photoCount': instance.photoCount,
  'messageCount': instance.messageCount,
  'downDownCount': instance.downDownCount,
  'eventImage': instance.eventImage,
  'eventCoverPhotoUrl': instance.eventCoverPhotoUrl,
