...
as DateTime,eventStartDatetimeGmt: null == eventStartDatetimeGmt ? _self.eventStartDatetimeGmt : eventStartDatetimeGmt // ignore: cast_nullable_to_non_nullable
...
as int?,trackRunnerCount: freezed == trackRunnerCount ? _self.trackRunnerCount : trackRunnerCount // ignore: cast_nullable_to_non_nullable
as int?,photoCount: freezed == photoCount ? _self.photoCount : photoCount // ignore: cast_nullable_to_non_nullable
as int?,messageCount: freezed == messageCount ? _self.messageCount : messageCount // ignore: cast_nullable_to_non_nullable
as int?,downDownCount: freezed == downDownCount ? _self.downDownCount : downDownCount // ignore: cast_nullable_to_non_nullable
as int?,eventImage: freezed == eventImage ? _self.eventImage : eventImage // ignore: cast_nullable_to_non_nullable
as String?,eventCoverPhotoUrl: freezed == eventCoverPhotoUrl ? _self.eventCoverPhotoUrl : eventCoverPhotoUrl // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String eventId,  String publicEventId,  DateTime eventStartDatetime,  DateTime eventStartDatetimeGmt,  String kennelId,  int isVisible,  int isCountedRun,  int isPromotedEvent,  int eventGeographicScope,  int eventInboundIntegrationId,  int eventNumber,  String eventName,  String countryId,  double? hcLatitude,  double? hcLongitude,  double? fbLatitude,  double? fbLongitude,  double? eventPriceForMembers,  double? eventPriceForNonMembers,  int? evtDisseminateAllowWebLinks,  String? eventFacebookId,  int? absoluteEventNumber,  int? canEditRunAttendence,  int? trackRunnerCount,  int? photoCount,  int? messageCount,  int? downDownCount,  String? eventImage,  String? eventCoverPhotoUrl,  String? eventDescription,  String? eventUrl,  String? locationOneLineDesc,  String? locationPostCode,  String? locationCity,  String? locationStreet,  String? locationCountry,  String? locationRegion,  String? locationSubRegion,  String? hares,  String? eventPaymentScheme,  String? eventPaymentUrl,  DateTime? eventPaymentUrlExpires,  int? unconfirmedBankXferCount,  double? eventPriceForExtras,  String? extrasDescription,  int doTrackHashCash,  int tags1,  int tags2,  int tags3,  int useFbLocation,  int useFbLatLon,  int useFbRunDetails,  int useFbImage,  int? removed,  DateTime? updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _EventModel() when $default != null:
return $default(_that.eventId,_that.publicEventId,_that.eventStartDatetime,_that.eventStartDatetimeGmt,_that.kennelId,_that.isVisible,_that.isCountedRun,_that.isPromotedEvent,_that.eventGeographicScope,_that.eventInboundIntegrationId,_that.eventNumber,_that.eventName,_that.countryId,_that.hcLatitude,_that.hcLongitude,_that.fbLatitude,_that.fbLongitude,_that.eventPriceForMembers,_that.eventPriceForNonMembers,_that.evtDisseminateAllowWebLinks,_that.eventFacebookId,_that.absoluteEventNumber,_that.canEditRunAttendence,_that.trackRunnerCount,_that.photoCount,_that.messageCount,_that.downDownCount,_that.eventImage,_that.eventCoverPhotoUrl,_that.eventDescription,_that.eventUrl,_that.locationOneLineDesc,_that.locationPostCode,_that.locationCity,_that.locationStreet,_that.locationCountry,_that.locationRegion,_that.locationSubRegion,_that.hares,_that.eventPaymentScheme,_that.eventPaymentUrl,_that.eventPaymentUrlExpires,_that.unconfirmedBankXferCount,_that.eventPriceForExtras,_that.extrasDescription,_that.doTrackHashCash,_that.tags1,_that.tags2,_that.tags3,_that.useFbLocation,_that.useFbLatLon,_that.useFbRunDetails,_that.useFbImage,_that.removed,_that.updatedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String eventId,  String publicEventId,  DateTime eventStartDatetime,  DateTime eventStartDatetimeGmt,  String kennelId,  int isVisible,  int isCountedRun,  int isPromotedEvent,  int eventGeographicScope,  int eventInboundIntegrationId,  int eventNumber,  String eventName,  String countryId,  double? hcLatitude,  double? hcLongitude,  double? fbLatitude,  double? fbLongitude,  double? eventPriceForMembers,  double? eventPriceForNonMembers,  int? evtDisseminateAllowWebLinks,  String? eventFacebookId,  int? absoluteEventNumber,  int? canEditRunAttendence,  int? trackRunnerCount,  int? photoCount,  int? messageCount,  int? downDownCount,  String? eventImage,  String? eventCoverPhotoUrl,  String? eventDescription,  String? eventUrl,  String? locationOneLineDesc,  String? locationPostCode,  String? locationCity,  String? locationStreet,  String? locationCountry,  String? locationRegion,  String? locationSubRegion,  String? hares,  String? eventPaymentScheme,  String? eventPaymentUrl,  DateTime? eventPaymentUrlExpires,  int? unconfirmedBankXferCount,  double? eventPriceForExtras,  String? extrasDescription,  int doTrackHashCash,  int tags1,  int tags2,  int tags3,  int useFbLocation,  int useFbLatLon,  int useFbRunDetails,  int useFbImage,  int? removed,  DateTime? updatedAt)  $default,) {final _that = this;
switch (_that) {
case _EventModel():
return $default(_that.eventId,_that.publicEventId,_that.eventStartDatetime,_that.eventStartDatetimeGmt,_that.kennelId,_that.isVisible,_that.isCountedRun,_that.isPromotedEvent,_that.eventGeographicScope,_that.eventInboundIntegrationId,_that.eventNumber,_that.eventName,_that.countryId,_that.hcLatitude,_that.hcLongitude,_that.fbLatitude,_that.fbLongitude,_that.eventPriceForMembers,_that.eventPriceForNonMembers,_that.evtDisseminateAllowWebLinks,_that.eventFacebookId,_that.absoluteEventNumber,_that.canEditRunAttendence,_that.trackRunnerCount,_that.photoCount,_that.messageCount,_that.downDownCount,_that.eventImage,_that.eventCoverPhotoUrl,_that.eventDescription,_that.eventUrl,_that.locationOneLineDesc,_that.locationPostCode,_that.locationCity,_that.locationStreet,_that.locationCountry,_that.locationRegion,_that.locationSubRegion,_that.hares,_that.eventPaymentScheme,_that.eventPaymentUrl,_that.eventPaymentUrlExpires,_that.unconfirmedBankXferCount,_that.eventPriceForExtras,_that.extrasDescription,_that.doTrackHashCash,_that.tags1,_that.tags2,_that.tags3,_that.useFbLocation,_that.useFbLatLon,_that.useFbRunDetails,_that.useFbImage,_that.removed,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String eventId,  String publicEventId,  DateTime eventStartDatetime,  DateTime eventStartDatetimeGmt,  String kennelId,  int isVisible,  int isCountedRun,  int isPromotedEvent,  int eventGeographicScope,  int eventInboundIntegrationId,  int eventNumber,  String eventName,  String countryId,  double? hcLatitude,  double? hcLongitude,  double? fbLatitude,  double? fbLongitude,  double? eventPriceForMembers,  double? eventPriceForNonMembers,  int? evtDisseminateAllowWebLinks,  String? eventFacebookId,  int? absoluteEventNumber,  int? canEditRunAttendence,  int? trackRunnerCount,  int? photoCount,  int? messageCount,  int? downDownCount,  String? eventImage,  String? eventCoverPhotoUrl,  String? eventDescription,  String? eventUrl,  String? locationOneLineDesc,  String? locationPostCode,  String? locationCity,  String? locationStreet,  String? locationCountry,  String? locationRegion,  String? locationSubRegion,  String? hares,  String? eventPaymentScheme,  String? eventPaymentUrl,  DateTime? eventPaymentUrlExpires,  int? unconfirmedBankXferCount,  double? eventPriceForExtras,  String? extrasDescription,  int doTrackHashCash,  int tags1,  int tags2,  int tags3,  int useFbLocation,  int useFbLatLon,  int useFbRunDetails,  int useFbImage,  int? removed,  DateTime? updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _EventModel() when $default != null:
return $default(_that.eventId,_that.publicEventId,_that.eventStartDatetime,_that.eventStartDatetimeGmt,_that.kennelId,_that.isVisible,_that.isCountedRun,_that.isPromotedEvent,_that.eventGeographicScope,_that.eventInboundIntegrationId,_that.eventNumber,_that.eventName,_that.countryId,_that.hcLatitude,_that.hcLongitude,_that.fbLatitude,_that.fbLongitude,_that.eventPriceForMembers,_that.eventPriceForNonMembers,_that.evtDisseminateAllowWebLinks,_that.eventFacebookId,_that.absoluteEventNumber,_that.canEditRunAttendence,_that.trackRunnerCount,_that.photoCount,_that.messageCount,_that.downDownCount,_that.eventImage,_that.eventCoverPhotoUrl,_that.eventDescription,_that.eventUrl,_that.locationOneLineDesc,_that.locationPostCode,_that.locationCity,_that.locationStreet,_that.locationCountry,_that.locationRegion,_that.locationSubRegion,_that.hares,_that.eventPaymentScheme,_that.eventPaymentUrl,_that.eventPaymentUrlExpires,_that.unconfirmedBankXferCount,_that.eventPriceForExtras,_that.extrasDescription,_that.doTrackHashCash,_that.tags1,_that.tags2,_that.tags3,_that.useFbLocation,_that.useFbLatLon,_that.useFbRunDetails,_that.useFbImage,_that.removed,_that.updatedAt);case _:
  return null;
...
class _EventModel with DiagnosticableTreeMixin implements EventModel {
   _EventModel({required this.eventId, required this.publicEventId, required this.eventStartDatetime, required this.eventStartDatetimeGmt, required this.kennelId, required this.isVisible, required this.isCountedRun, required this.isPromotedEvent, required this.eventGeographicScope, required this.eventInboundIntegrationId, required this.eventNumber, required this.eventName, required this.countryId, this.hcLatitude, this.hcLongitude, this.fbLatitude, this.fbLongitude, this.eventPriceForMembers, this.eventPriceForNonMembers, this.evtDisseminateAllowWebLinks, this.eventFacebookId, this.absoluteEventNumber, this.canEditRunAttendence, this.trackRunnerCount, this.photoCount, this.messageCount, this.downDownCount, this.eventImage, this.eventCoverPhotoUrl, this.eventDescription, this.eventUrl, this.locationOneLineDesc, this.locationPostCode, this.locationCity, this.locationStreet, this.locationCountry, this.locationRegion, this.locationSubRegion, this.hares, this.eventPaymentScheme, this.eventPaymentUrl, this.eventPaymentUrlExpires, this.unconfirmedBankXferCount, this.eventPriceForExtras, this.extrasDescription, required this.doTrackHashCash, required this.tags1, required this.tags2, required this.tags3, required this.useFbLocation, required this.useFbLatLon, required this.useFbRunDetails, required this.useFbImage, this.removed, this.updatedAt});
...
@override final  DateTime eventStartDatetimeGmt;
...
// Activity counts for the run card, synced with the row (E5.F7.S1).
@override final  int? trackRunnerCount;
@override final  int? photoCount;
@override final  int? messageCount;
@override final  int? downDownCount;
@override final  String? eventImage;
@override final  String? eventCoverPhotoUrl;
