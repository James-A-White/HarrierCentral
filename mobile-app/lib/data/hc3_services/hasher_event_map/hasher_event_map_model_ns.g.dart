...
_HasherEventMapModel _$HasherEventMapModelFromJson(Map<String, dynamic> json) =>
    _HasherEventMapModel(
      ...
      notesVisibility: (json['notesVisibility'] as num?)?.toInt(),
      notesShared: (json['notesShared'] as num?)?.toInt(),
      trackGzip: json['trackGzip'] as String?,
      trackPointCount: (json['trackPointCount'] as num?)?.toInt(),
      trackFirstPointAt: json['trackFirstPointAt'] as String?,
      trackLastPointAt: json['trackLastPointAt'] as String?,
      hemEventName: json['hemEventName'] as String?,
      hemCountryId: json['hemCountryId'] as String?,
...
Map<String, dynamic> _$HasherEventMapModelToJson(
  ...
  'notesVisibility': instance.notesVisibility,
  'notesShared': instance.notesShared,
  'trackGzip': instance.trackGzip,
  'trackPointCount': instance.trackPointCount,
  'trackFirstPointAt': instance.trackFirstPointAt,
  'trackLastPointAt': instance.trackLastPointAt,
