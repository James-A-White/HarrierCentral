...
mixin _$HasherEventMapModel implements DiagnosticableTreeMixin {
 ...
 int? get notesShared;// these fields are cached from the event itself. This enables us to keep run count information without
...
as int?,hemEventName: freezed == hemEventName ? _self.hemEventName : hemEventName // ignore: cast_nullable_to_non_nullable
