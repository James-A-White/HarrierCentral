...
mixin _$HasherEventMapModel implements DiagnosticableTreeMixin {
 ...
 String get hemId; String get userId; String get eventId; String? get hasherOwnEventId; String? get userStartEvent; String? get userEndEvent; int get rsvpState; int get attendenceState; int get isHare; int? get eventNotificationPreference; int? get eventEmailAlertPreference; int? get totalHaring; int? get totalHaringThisKennel; int? get totalRuns; int? get totalRunsThisKennel; int? get eventCountOverride; int get virginVisitorType; String? get displayName; String? get email; String? get phoneNumber;// The hasher's own private notes on the run (user sync only).
 String? get notes;// 0 private · 1 shared (the hasher's own choice).
 int? get notesVisibility;// 1 when shared AND neither admin override hides it (server-computed).
 int? get notesShared;// The hasher's own archived PackTrack trail (user sync only; E5.F7.S1):
...
// phone by TrackArchiveCodec. Null until the nightly archive has run.
 String? get trackGzip; int? get trackPointCount; String? get trackFirstPointAt; String? get trackLastPointAt;// these fields are cached from the event itself. This enables us to keep run count information without
// having to have the actual run cached on the phone
 String? get hemEventName; String? get hemCountryId; int? get hemEventNumber; DateTime get hemEventStartDatetime; DateTime get hemEventStartDatetimeGmt; int? get hemCanEditRunAttendence; String? get hemEventKennelId; int? get hemEventIsCountedAndVisible; String? get hemKennelUserPhoto; String? get hemKennelHashName;/// Pinned chat (E9.F1.S8). Two states only: a run never auto-pins, and a
/// run pin never expires — the system does not undo what the hasher did.
 int? get pinned; int? get removed; DateTime? get updatedAt;
...
@useResult
$Res call({
 String hemId, String userId, String eventId, String? hasherOwnEventId, String? userStartEvent, String? userEndEvent, int rsvpState, int attendenceState, int isHare, int? eventNotificationPreference, int? eventEmailAlertPreference, int? totalHaring, int? totalHaringThisKennel, int? totalRuns, int? totalRunsThisKennel, int? eventCountOverride, int virginVisitorType, String? displayName, String? email, String? phoneNumber, String? notes, int? notesVisibility, int? notesShared, String? trackGzip, int? trackPointCount, String? trackFirstPointAt, String? trackLastPointAt, String? hemEventName, String? hemCountryId, int? hemEventNumber, DateTime hemEventStartDatetime, DateTime hemEventStartDatetimeGmt, int? hemCanEditRunAttendence, String? hemEventKennelId, int? hemEventIsCountedAndVisible, String? hemKennelUserPhoto, String? hemKennelHashName, int? pinned, int? removed, DateTime? updatedAt
});
...
/// Create a copy of HasherEventMapModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? hemId = null,Object? userId = null,Object? eventId = null,Object? hasherOwnEventId = freezed,Object? userStartEvent = freezed,Object? userEndEvent = freezed,Object? rsvpState = null,Object? attendenceState = null,Object? isHare = null,Object? eventNotificationPreference = freezed,Object? eventEmailAlertPreference = freezed,Object? totalHaring = freezed,Object? totalHaringThisKennel = freezed,Object? totalRuns = freezed,Object? totalRunsThisKennel = freezed,Object? eventCountOverride = freezed,Object? virginVisitorType = null,Object? displayName = freezed,Object? email = freezed,Object? phoneNumber = freezed,Object? notes = freezed,Object? notesVisibility = freezed,Object? notesShared = freezed,Object? trackGzip = freezed,Object? trackPointCount = freezed,Object? trackFirstPointAt = freezed,Object? trackLastPointAt = freezed,Object? hemEventName = freezed,Object? hemCountryId = freezed,Object? hemEventNumber = freezed,Object? hemEventStartDatetime = null,Object? hemEventStartDatetimeGmt = null,Object? hemCanEditRunAttendence = freezed,Object? hemEventKennelId = freezed,Object? hemEventIsCountedAndVisible = freezed,Object? hemKennelUserPhoto = freezed,Object? hemKennelHashName = freezed,Object? pinned = freezed,Object? removed = freezed,Object? updatedAt = freezed,}) {
...
as String?,notesVisibility: freezed == notesVisibility ? _self.notesVisibility : notesVisibility // ignore: cast_nullable_to_non_nullable
as int?,notesShared: freezed == notesShared ? _self.notesShared : notesShared // ignore: cast_nullable_to_non_nullable
as int?,trackGzip: freezed == trackGzip ? _self.trackGzip : trackGzip // ignore: cast_nullable_to_non_nullable
as String?,trackPointCount: freezed == trackPointCount ? _self.trackPointCount : trackPointCount // ignore: cast_nullable_to_non_nullable
as int?,trackFirstPointAt: freezed == trackFirstPointAt ? _self.trackFirstPointAt : trackFirstPointAt // ignore: cast_nullable_to_non_nullable
as String?,trackLastPointAt: freezed == trackLastPointAt ? _self.trackLastPointAt : trackLastPointAt // ignore: cast_nullable_to_non_nullable
...
as DateTime,hemEventStartDatetimeGmt: null == hemEventStartDatetimeGmt ? _self.hemEventStartDatetimeGmt : hemEventStartDatetimeGmt // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _HasherEventMapModel() when $default != null:
return $default(_that.hemId,_that.userId,_that.eventId,_that.hasherOwnEventId,_that.userStartEvent,_that.userEndEvent,_that.rsvpState,_that.attendenceState,_that.isHare,_that.eventNotificationPreference,_that.eventEmailAlertPreference,_that.totalHaring,_that.totalHaringThisKennel,_that.totalRuns,_that.totalRunsThisKennel,_that.eventCountOverride,_that.virginVisitorType,_that.displayName,_that.email,_that.phoneNumber,_that.notes,_that.notesVisibility,_that.notesShared,_that.trackGzip,_that.trackPointCount,_that.trackFirstPointAt,_that.trackLastPointAt,_that.hemEventName,_that.hemCountryId,_that.hemEventNumber,_that.hemEventStartDatetime,_that.hemEventStartDatetimeGmt,_that.hemCanEditRunAttendence,_that.hemEventKennelId,_that.hemEventIsCountedAndVisible,_that.hemKennelUserPhoto,_that.hemKennelHashName,_that.pinned,_that.removed,_that.updatedAt);case _:
  return orElse();
...
class _HasherEventMapModel with DiagnosticableTreeMixin implements HasherEventMapModel {
   _HasherEventMapModel({required this.hemId, required this.userId, required this.eventId, this.hasherOwnEventId, this.userStartEvent, this.userEndEvent, required this.rsvpState, required this.attendenceState, required this.isHare, this.eventNotificationPreference, this.eventEmailAlertPreference, this.totalHaring, this.totalHaringThisKennel, this.totalRuns, this.totalRunsThisKennel, this.eventCountOverride, required this.virginVisitorType, this.displayName, this.email, this.phoneNumber, this.notes, this.notesVisibility, this.notesShared, this.trackGzip, this.trackPointCount, this.trackFirstPointAt, this.trackLastPointAt, this.hemEventName, this.hemCountryId, this.hemEventNumber, required this.hemEventStartDatetime, required this.hemEventStartDatetimeGmt, this.hemCanEditRunAttendence, this.hemEventKennelId, this.hemEventIsCountedAndVisible, this.hemKennelUserPhoto, this.hemKennelHashName, this.pinned, this.removed, this.updatedAt});
...
@override final  int? notesVisibility;
// 1 when shared AND neither admin override hides it (server-computed).
@override final  int? notesShared;
// The hasher's own archived PackTrack trail (user sync only; E5.F7.S1):
// base64 of the server's gzipped delta-coded points, decoded on the
// phone by TrackArchiveCodec. Null until the nightly archive has run.
@override final  String? trackGzip;
@override final  int? trackPointCount;
@override final  String? trackFirstPointAt;
@override final  String? trackLastPointAt;
...
@override final  DateTime hemEventStartDatetimeGmt;
