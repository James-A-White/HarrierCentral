...
_KennelModel _$KennelModelFromJson(Map<String, dynamic> json) => _KennelModel(
  kennelPublicId: const UuidConverter().fromJson(
    json['kennelPublicId'] as String,
  ),
  ...
  disseminateHashRunsDotOrg: (json['disseminateHashRunsDotOrg'] as num).toInt(),
  ...
  notificationMinutesBeforeRunForCheckinReminder:
      (json['notificationMinutesBeforeRunForCheckinReminder'] as num).toInt(),
  ...
  publishToGoogleCalendar: (json['publishToGoogleCalendar'] as num?)?.toInt(),
...
Map<String, dynamic> _$KennelModelToJson(
  _KennelModel instance,
) => <String, dynamic>{
  ...
  'publishToGoogleCalendarAddresses': instance.publishToGoogleCalendarAddresses,
  ...
  'websiteMismanagementDescription': instance.websiteMismanagementDescription,
