...
_RunDetailsModel _$RunDetailsModelFromJson(
  ...
  kenDisseminateHashRunsDotOrg: (json['kenDisseminateHashRunsDotOrg'] as num)
      .toInt(),
  kenDisseminateAllowWebLinks: (json['kenDisseminateAllowWebLinks'] as num)
      .toInt(),
  kenDisseminationAudience: (json['kenDisseminationAudience'] as num).toInt(),
  ...
  eventCityLatitude: (json['eventCityLatitude'] as num?)?.toDouble(),
  eventCityLongitude: (json['eventCityLongitude'] as num?)?.toDouble(),
  eventCountryCodes: json['eventCountryCodes'] as String?,
  publicEventId: json['publicEventId'] as String?,
  evtDisseminationAudience: (json['evtDisseminationAudience'] as num?)?.toInt(),
  evtDisseminateAllowWebLinks: (json['evtDisseminateAllowWebLinks'] as num?)
      ?.toInt(),
  evtDisseminateHashRunsDotOrg: (json['evtDisseminateHashRunsDotOrg'] as num?)
      ?.toInt(),
  ...
  maximumParticipantsAllowed: (json['maximumParticipantsAllowed'] as num?)
      ?.toInt(),
  minimumParticipantsRequired: (json['minimumParticipantsRequired'] as num?)
      ?.toInt(),
...
Map<String, dynamic> _$RunDetailsModelToJson(
  _RunDetailsModel instance,
) => <String, dynamic>{
  ...
  'eventCityLatitude': instance.eventCityLatitude,
  'eventCityLongitude': instance.eventCityLongitude,
  'eventCountryCodes': instance.eventCountryCodes,
  ...
  'extEventStartDatetime': instance.extEventStartDatetime?.toIso8601String(),
