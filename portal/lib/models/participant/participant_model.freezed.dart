...
mixin _$ParticipantModel {
 ...
 String get displayName; int get rsvpState; int get attendanceState; int get isHare; int get totalRunsThisKennel; int get totalHaringThisKennel; String get amountPaidStr; String get amountOwedStr; String get creditAvailableStr; int get virginVisitorType;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ParticipantModel&&(identical(other.displayName, displayName) || other.displayName == displayName)&&(identical(other.rsvpState, rsvpState) || other.rsvpState == rsvpState)&&(identical(other.attendanceState, attendanceState) || other.attendanceState == attendanceState)&&(identical(other.isHare, isHare) || other.isHare == isHare)&&(identical(other.totalRunsThisKennel, totalRunsThisKennel) || other.totalRunsThisKennel == totalRunsThisKennel)&&(identical(other.totalHaringThisKennel, totalHaringThisKennel) || other.totalHaringThisKennel == totalHaringThisKennel)&&(identical(other.amountPaidStr, amountPaidStr) || other.amountPaidStr == amountPaidStr)&&(identical(other.amountOwedStr, amountOwedStr) || other.amountOwedStr == amountOwedStr)&&(identical(other.creditAvailableStr, creditAvailableStr) || other.creditAvailableStr == creditAvailableStr)&&(identical(other.virginVisitorType, virginVisitorType) || other.virginVisitorType == virginVisitorType));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,displayName,rsvpState,attendanceState,isHare,totalRunsThisKennel,totalHaringThisKennel,amountPaidStr,amountOwedStr,creditAvailableStr,virginVisitorType);
...
@useResult
$Res call({
 String displayName, int rsvpState, int attendanceState, int isHare, int totalRunsThisKennel, int totalHaringThisKennel, String amountPaidStr, String amountOwedStr, String creditAvailableStr, int virginVisitorType
});
...
/// Create a copy of ParticipantModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? displayName = null,Object? rsvpState = null,Object? attendanceState = null,Object? isHare = null,Object? totalRunsThisKennel = null,Object? totalHaringThisKennel = null,Object? amountPaidStr = null,Object? amountOwedStr = null,Object? creditAvailableStr = null,Object? virginVisitorType = null,}) {
...
as int,attendanceState: null == attendanceState ? _self.attendanceState : attendanceState // ignore: cast_nullable_to_non_nullable
...
as int,amountPaidStr: null == amountPaidStr ? _self.amountPaidStr : amountPaidStr // ignore: cast_nullable_to_non_nullable
as String,amountOwedStr: null == amountOwedStr ? _self.amountOwedStr : amountOwedStr // ignore: cast_nullable_to_non_nullable
as String,creditAvailableStr: null == creditAvailableStr ? _self.creditAvailableStr : creditAvailableStr // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String displayName,  int rsvpState,  int attendanceState,  int isHare,  int totalRunsThisKennel,  int totalHaringThisKennel,  String amountPaidStr,  String amountOwedStr,  String creditAvailableStr,  int virginVisitorType)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ParticipantModel() when $default != null:
return $default(_that.displayName,_that.rsvpState,_that.attendanceState,_that.isHare,_that.totalRunsThisKennel,_that.totalHaringThisKennel,_that.amountPaidStr,_that.amountOwedStr,_that.creditAvailableStr,_that.virginVisitorType);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String displayName,  int rsvpState,  int attendanceState,  int isHare,  int totalRunsThisKennel,  int totalHaringThisKennel,  String amountPaidStr,  String amountOwedStr,  String creditAvailableStr,  int virginVisitorType)  $default,) {final _that = this;
switch (_that) {
case _ParticipantModel():
return $default(_that.displayName,_that.rsvpState,_that.attendanceState,_that.isHare,_that.totalRunsThisKennel,_that.totalHaringThisKennel,_that.amountPaidStr,_that.amountOwedStr,_that.creditAvailableStr,_that.virginVisitorType);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String displayName,  int rsvpState,  int attendanceState,  int isHare,  int totalRunsThisKennel,  int totalHaringThisKennel,  String amountPaidStr,  String amountOwedStr,  String creditAvailableStr,  int virginVisitorType)?  $default,) {final _that = this;
switch (_that) {
case _ParticipantModel() when $default != null:
return $default(_that.displayName,_that.rsvpState,_that.attendanceState,_that.isHare,_that.totalRunsThisKennel,_that.totalHaringThisKennel,_that.amountPaidStr,_that.amountOwedStr,_that.creditAvailableStr,_that.virginVisitorType);case _:
  return null;
...
class _ParticipantModel implements ParticipantModel {
  const _ParticipantModel({required this.displayName, required this.rsvpState, required this.attendanceState, required this.isHare, required this.totalRunsThisKennel, required this.totalHaringThisKennel, required this.amountPaidStr, required this.amountOwedStr, required this.creditAvailableStr, required this.virginVisitorType});
...
@override final  int attendanceState;
@override final  int isHare;
@override final  int totalRunsThisKennel;
@override final  int totalHaringThisKennel;
@override final  String amountPaidStr;
@override final  String amountOwedStr;
@override final  String creditAvailableStr;
...
/// Create a copy of ParticipantModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? displayName = null,Object? rsvpState = null,Object? attendanceState = null,Object? isHare = null,Object? totalRunsThisKennel = null,Object? totalHaringThisKennel = null,Object? amountPaidStr = null,Object? amountOwedStr = null,Object? creditAvailableStr = null,Object? virginVisitorType = null,}) {
