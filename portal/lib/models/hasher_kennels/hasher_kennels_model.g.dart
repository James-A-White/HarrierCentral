...
_HasherKennelsModel _$HasherKennelsModelFromJson(
  ...
  canEditWebsite: (json['canEditWebsite'] as num?)?.toInt() ?? 0,
  canDesignWebsite: (json['canDesignWebsite'] as num?)?.toInt() ?? 0,
  canManageProducts: (json['canManageProducts'] as num?)?.toInt() ?? 0,
...
Map<String, dynamic> _$HasherKennelsModelToJson(_HasherKennelsModel instance) =>
    <String, dynamic>{
      ...
      'canEditWebsite': instance.canEditWebsite,
      'canDesignWebsite': instance.canDesignWebsite,
