...
$UdNewEventsModelCopyWith<UdNewEventsModel> get copyWith => _$UdNewEventsModelCopyWithImpl<UdNewEventsModel>(this as UdNewEventsModel, _$identity);
...
as String,minutesAgoUpdated: null == minutesAgoUpdated ? _self.minutesAgoUpdated : minutesAgoUpdated // ignore: cast_nullable_to_non_nullable
as int,minutesAgoCreated: null == minutesAgoCreated ? _self.minutesAgoCreated : minutesAgoCreated // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _UdNewEventsModel value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _UdNewEventsModel value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _UdNewEventsModel value)?  $default,){
final _that = this;
switch (_that) {
case _UdNewEventsModel() when $default != null:
return $default(_that);case _:
...
@override final  int minutesAgoUpdated;
@override final  int minutesAgoCreated;
...
@pragma('vm:prefer-inline')
_$UdNewEventsModelCopyWith<_UdNewEventsModel> get copyWith => __$UdNewEventsModelCopyWithImpl<_UdNewEventsModel>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$UdNewEventsModelToJson(this, );
}
@override
void debugFillProperties(DiagnosticPropertiesBuilder properties) {
  properties
...
/// @nodoc
abstract mixin class _$UdNewEventsModelCopyWith<$Res> implements $UdNewEventsModelCopyWith<$Res> {
