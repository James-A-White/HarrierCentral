...
$UdIntegrationMonitorModelCopyWith<UdIntegrationMonitorModel> get copyWith => _$UdIntegrationMonitorModelCopyWithImpl<UdIntegrationMonitorModel>(this as UdIntegrationMonitorModel, _$identity);
...
as int,recordsWritten: null == recordsWritten ? _self.recordsWritten : recordsWritten // ignore: cast_nullable_to_non_nullable
as int,recordsFailedInfo: null == recordsFailedInfo ? _self.recordsFailedInfo : recordsFailedInfo // ignore: cast_nullable_to_non_nullable
as String,errorCount: null == errorCount ? _self.errorCount : errorCount // ignore: cast_nullable_to_non_nullable
as int,errorInfo: null == errorInfo ? _self.errorInfo : errorInfo // ignore: cast_nullable_to_non_nullable
as String,kennelsSucceeded: null == kennelsSucceeded ? _self.kennelsSucceeded : kennelsSucceeded // ignore: cast_nullable_to_non_nullable
as int,kennelsSucceededInfo: null == kennelsSucceededInfo ? _self.kennelsSucceededInfo : kennelsSucceededInfo // ignore: cast_nullable_to_non_nullable
as String,kennelsFailed: null == kennelsFailed ? _self.kennelsFailed : kennelsFailed // ignore: cast_nullable_to_non_nullable
as int,kennelsFailedInfo: null == kennelsFailedInfo ? _self.kennelsFailedInfo : kennelsFailedInfo // ignore: cast_nullable_to_non_nullable
as String,integrationAbbreviation: null == integrationAbbreviation ? _self.integrationAbbreviation : integrationAbbreviation // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _UdIntegrationMonitorModel value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _UdIntegrationMonitorModel value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _UdIntegrationMonitorModel value)?  $default,){
final _that = this;
switch (_that) {
case _UdIntegrationMonitorModel() when $default != null:
return $default(_that);case _:
...
@override final  int recordsRead;
@override final  int recordsWritten;
// required String recordSuccessInfo,
@override final  String recordsFailedInfo;
@override final  int errorCount;
@override final  String errorInfo;
@override final  int kennelsSucceeded;
@override final  String kennelsSucceededInfo;
@override final  int kennelsFailed;
@override final  String kennelsFailedInfo;
@override final  String integrationAbbreviation;
...
@pragma('vm:prefer-inline')
_$UdIntegrationMonitorModelCopyWith<_UdIntegrationMonitorModel> get copyWith => __$UdIntegrationMonitorModelCopyWithImpl<_UdIntegrationMonitorModel>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$UdIntegrationMonitorModelToJson(this, );
}
@override
void debugFillProperties(DiagnosticPropertiesBuilder properties) {
  properties
...
/// @nodoc
abstract mixin class _$UdIntegrationMonitorModelCopyWith<$Res> implements $UdIntegrationMonitorModelCopyWith<$Res> {
