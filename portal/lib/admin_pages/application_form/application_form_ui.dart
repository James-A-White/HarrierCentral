...
class TestFormPage extends StatelessWidget {
  ...
  ApplicationFormController get applicationGetxController =>
      Get.find<ApplicationFormController>();

  @override
  Widget build(BuildContext context) {
    try {
      return GetBuilder<ApplicationFormController>(
          init: ApplicationFormController(applicationData),
  ...
  List<Widget> _getTabs() {
    ...
    for (var item in AppTabKeyEnums.values) {
      tabs.add(TabWithIcon<ApplicationFormController>(
          label: item.title,
          tabIndex: item.idx,
          controller: applicationGetxController));
    }
