...
export "FLUTTER_FRAMEWORK_DIR=/users/jameswhite/desktop/Development/flutter/bin/cache/artifacts/engine/ios"
export "FLUTTER_BUILD_NAME=0.8.220"
export "FLUTTER_BUILD_NUMBER=340"
